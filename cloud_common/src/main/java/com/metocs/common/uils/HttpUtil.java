...
public class HttpUtil {
    ...
    public static String postParam(String url, Map<String, Object> params) throws UnsupportedEncodingException {
        HttpPost httpPost = new HttpPost(url);
        ArrayList<NameValuePair> pairs = covertParams2NVPS(params);
    ...
    public static String postHeaderParam(String url, Map<String, Object> headers, Map<String, Object> params)
    ...
    private static String getResult(HttpRequestBase request) {
        ...
        try {
            ...
            throw new RuntimeException("HttpClientUtil ClientProtocolException ：" + e.getMessage());
        } catch (IOException e) {
            log.error("[maperror] HttpClientUtil IOException : " + e.getMessage());
            throw new RuntimeException("HttpClientUtil IOException ：" + e.getMessage());
        }
        return EMPTY_STR;
    }
}
